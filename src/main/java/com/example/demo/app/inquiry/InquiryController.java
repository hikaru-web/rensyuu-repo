...
//		}
	...
	public String form(InquiryForm inquiryForm,
			...
			//↑フラッシュスコープを受け取るときは@が必要
			//こうすることで、フラッシュスコープの値をhtmlでレンダリング（＝htmlで表現）してくれる。
	...
	@PostMapping("/confirm")
	//@Validatedをつけると、ここに来る前にバリデーションをかけてくれる
	//resultには、バリデーションをかけた後の結果が入ってくる
	public String confirm(@Validated InquiryForm inquiryForm,
			BindingResult result,
			Model model) {

		// バリデーションの後にエラーがあるとtrueが帰ってくる
		if (result.hasErrors()) {
			model.addAttribute("title", "Inquiry Form");
			return "Inquiry/form";
		}
